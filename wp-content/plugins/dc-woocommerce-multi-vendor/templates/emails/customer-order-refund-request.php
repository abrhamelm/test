...
<div style="font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin-bottom: 40px;">
    <?php if( $user_type != 'customer' ) { ?>
		...
		<ul>
                ...
                <li><strong><?php printf(__( 'Admin order link : <a href="%s" title="%s">#%s</a> ', 'dc-woocommerce-multi-vendor' ), admin_url( 'post.php?post=' . absint( $order->get_id() ) . '&action=edit' ) , sanitize_title($order->get_status()), $order->get_order_number()  ); ?></span></li>
