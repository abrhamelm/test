...
<p style="text-align:<?php echo $text_align; ?>;" >
	<?php printf( __( "Hi %s,",  'dc-woocommerce-multi-vendor' ), $vendor->page_title ); ?><br><br>
	<?php printf( __( "A new query has been added by your potential buyer - %s",  'dc-woocommerce-multi-vendor' ), $customer_name ); ?><br>
	<?php printf( __( "Product Name : %s",  'dc-woocommerce-multi-vendor' ), $product_name ); ?><br>
